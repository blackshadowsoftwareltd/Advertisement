import 'package:Facebook_Audience_Network/SecondPage.dart';
...
class _HomeState extends State<Home> {
  ...
  var _placementId = 'IMG_16_9_APP_INSTALL#2312433698835503_2650502525028617';

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Facebook Audience Network"),
      ),
      body: Column(
  ...
  _showInterstitialAd() {
    if (isInterstitialAdLoaded == true) {
      ...
      print('Ad is not loaded xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx');
    }
  }
